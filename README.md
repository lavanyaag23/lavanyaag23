...
public class Lavanya {
    ...
    String[] currentlyBuilding = {
        "CodeQuest Arena — a multi-game browser hub with a dark-neon glassmorphic UI",
        "Personal portfolio site — dark gold/rose editorial theme with rich VFX",
...
|:---:|--------|------------|------|
| 🎮 | **[CodeQuest Arena](https://codequest-arena-lavanya.vercel.app)** | Multi-game browser hub — 13 games plus Developer Lab tools (Bug Hunter, Commit Predictor & more) in a dark-neon glassmorphic UI | `HTML` `CSS` `JavaScript` |
